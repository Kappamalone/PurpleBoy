...
type gameboyCPU struct {
	...
	memory [16 * 1024]uint8 //16kb of RAM
}
...
func (cpu *gameboyCPU) read(addr uint16) uint8 {
	return cpu.memory[addr]
}

func (cpu *gameboyCPU) write(addr uint16,value uint8){
...
func (cpu *gameboyCPU) hflag(original uint8, val uint8) {
